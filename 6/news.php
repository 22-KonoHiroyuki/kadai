...
$sql = "SELECT create_date,news_title,news_detail FROM news where news_id = '$unique_id'";
...
<body>
    ...
    <span class="section-title-ja text-center">
        <?php echo substr($row['create_date'],0,10); ?></span>
    </h2>
    ...
    <h2 class="section-title text-center">
        <span class="section-title__white">Information</span>
        <span class="section-title-ja section-title__white text-center">基本情報</span>
    </h2>
